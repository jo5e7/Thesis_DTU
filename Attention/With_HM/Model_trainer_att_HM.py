...
from Attention.With_HM.Trainable_Model_att_HM import Trainable_Model_Att
...
import Attention.With_HM.DenseNet_Att_HM as models

def get_densenet_att(target, target_loc, type=169, bp_elementwise=False):
    if type is 169:
        densenet_att = models.densenet_att_hm_169(pretrained=True, bp_elementwise=bp_elementwise)
        print("DenseNet_169")
    elif type is 161:
...
def get_densenet_multi_att(target, target_loc, type=169, bp_position=False, all_in_1_reduction=False, hidden_layers_att=1,
    ...
    if type is 169:
        densenet_MA = models.densenet_att_hm_169(pretrained=True, bp_elementwise=bp_position, all_in_1_reduction=all_in_1_reduction,
                                                 hidden_layers_att=hidden_layers_att, kernel_att=kernel_att, stride_att=stride_att)
        print("DenseNet_169")
    elif type is 161:
...
if __name__ == '__main__':
    ...
    kernel_att = 3
    stride_att = 1
    densenet = get_densenet_multi_att(radiographic_findings_opacity, locations_labels, type=169, bp_position=bp_att,
                                      hidden_layers_att=hidden_lyrs, kernel_att=kernel_att, stride_att=stride_att)
