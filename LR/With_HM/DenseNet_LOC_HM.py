...
class DenseNet_LOC_HM(nn.Module):
...
def densenet_loc_hm_169(pretrained=False, all_in_1_reduction=False, **kwargs):
    ...
    """
    model = DenseNet_LOC_HM(num_init_features=64, growth_rate=32, block_config=(6, 12, 32, 32), all_in_1_reduction=all_in_1_reduction,
                     **kwargs)
...
def loadSD_densenet_loc_hm_169(pretrained=True, model_state_dict='', **kwargs):
    r"""Densenet-121 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
